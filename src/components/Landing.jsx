...
const Landing = ({ setSelectedPage }) => {
	...
	return (
		...
		>
            ...
            before:w-full before:max-w-[400px] md:before:max-w-[600px] before:h-full before:border-2 before:border-blue before:z-[-1] before:group-hover:border-red group"
					>
						<img
							src={profilePicture}
							alt="profile"
			...
			<div className="z-30 basis-2/5 mt-12 md:mt-32">
              ...
              before:absolute before:-left-[25px] before:-top-[70px] before:z-[-1]"
				...
				{/* CALL TO ACTIONS */}
				<motion.div
					className="flex mt-5 justify-center md:justify-start gap-5"
					initial="hidden"
					whileInView="visible"
					viewport={{ once: true, amount: 0.5 }}
              ...
              hover:bg-blue hover:text-white transition duration-500"
					...
					<AnchorLink
						className="bg-gradient-rainblue py-0.5"
						onClick={() => setSelectedPage("contact")}
						href="#contact"
					>
